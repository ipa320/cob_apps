...
class sdhParameter:
	...
	home.velocities=[0,0,0,0,0,0,0]

	cylClose = JointCommand()
	cylClose.joint_names = joint_names
	cylClose.positions=[0,0.7,1.5,1.5,0.7,1.5,0]
	cylClose.velocities=[0,0,0,0,0,0,0]

	cylOpen = JointCommand()
	cylOpen.joint_names = joint_names
	cylOpen.positions=[0,0.7,1.5,1.5,0.7,1.5,0]
	cylOpen.velocities=[0,0,0,0,0,0,0]

	spherClose = JointCommand()
	spherClose.joint_names = joint_names
	spherClose.positions=[0,0.7,1.5,1.5,0.7,1.5,0]
	spherClose.velocities=[0,0,0,0,0,0,0]

	spherOpen = JointCommand()
	spherOpen.joint_names = joint_names
	spherOpen.positions=[0,0.7,1.5,1.5,0.7,1.5,0]
	spherOpen.velocities=[0,0,0,0,0,0,0]
